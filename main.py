# The plan for this project is to create the best playfair cipher 
# cracker by analyzing patterns in the ciphertext
...
def decrypt(text, key):
    ...
    for i in range(0, len(text), 2):
        ...
        if r1 == r2:
            string += grid[r1][(c1 - 1) % 5]
            string += grid[r2][(c2 - 1) % 5]

        elif c1 == c2:
            string += grid[(r1 - 1) % 5][c1]
            string += grid[(r2 - 1) % 5][c2]
